...
// // Helper wrapper to handle try-catch cleanly
...
//       {
//         $project: {
//           name: 1, email: 1, role: 1, salary: 1,
//           departmentName: '$departmentDetails.name'
//         }
//       }
//     ];
//     handleAggregation(User, pipeline, res);
//   },
...
//       { $unwind: '$department' }
//     ];
//     handleAggregation(Project, pipeline, res);
//   },
...
//       {
//         $project: {
//           _id: 0, userName: '$user.name', totalTasks: 1
//         }
//       }
//     ];
//     handleAggregation(Task, pipeline, res);
//   },
...
//   // 11. Show each department with total users, total projects, and total budget
...
//       }
//     ];
//     handleAggregation(Department, pipeline, res);
//   },
...
//   // 14. For each project show: total tasks, total completed tasks, total hours worked
...
//   // 15. Show monthly user registration count (group by month)
...
//   // 18. Show project efficiency report (name, budget, total hours, unique employees)
...
//           _id: '$projectId',
//           totalHoursWorked: { $sum: '$hoursWorked' },
//           employees: { $addToSet: '$assignedTo' } // unique employees
//         }
//       },
//       {
//         $lookup: {
...
//           totalHoursWorked: 1,
//           totalEmployeesInvolved: { $size: '$employees' }
//         }
//       }
//     ];
//     handleAggregation(Task, pipeline, res);
...
//     try {
//       // Combining discrete metric metrics into a single structural response object.
//       const statsPipeline = await User.aggregate([
//         {
//           $facet: {
//             totalUsers: [{ $count: 'count' }],
//             totalSalaryExpense: [{ $group: { _id: null, total: { $sum: '$salary' } } }]
//           }
//         }
//       ]);

//       const totalDepartments = await Department.countDocuments();
//       const totalActiveProjects = await Project.countDocuments({ status: 'active' });
//       const totalCompletedTasks = await Task.countDocuments({ status: 'completed' });

//       const metrics = {
//         totalUsers: statsPipeline[0].totalUsers[0]?.count || 0,
//         totalDepartments,
//         totalActiveProjects,
//         totalCompletedTasks,
//         totalSalaryExpense: statsPipeline[0].totalSalaryExpense[0]?.total || 0
//       };
